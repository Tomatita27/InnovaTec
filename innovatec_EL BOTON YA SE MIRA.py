...
frame_central.pack(pady=0, anchor="center")
...
frame_textboxes.grid(row=1, column=0, pady=0)
...
for i in range(3):
    ...
    frame_labels.grid(row=0, column=0, pady=0, sticky="ns")
...
frame_examen.grid(row=1, column=1, pady=0, padx=50)
...
boton_exameneva.grid(row=1, pady=0)
...
frame_abajo = tk.Frame(root) #cambia el padre a root
frame_abajo.pack(side="top", pady=10)
